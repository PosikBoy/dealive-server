...
class TokenService {
    ...
    getRefreshToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenData = yield refreshToken_model_1.default.getRefreshToken(refreshToken);
            return tokenData || null;
        });
    }
    saveRefreshToken(previousRefreshToken, refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield refreshToken_model_1.default.saveRefreshToken(previousRefreshToken, refreshToken);
            return result;
        });
    }
    addRefreshToken(refreshToken, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield refreshToken_model_1.default.addRefreshToken(refreshToken, userId);
            return result;
        });
    }
    removeRefreshToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const token = yield refreshToken_model_1.default.removeRefreshToken(refreshToken);
            return token;
        });
    }
}
